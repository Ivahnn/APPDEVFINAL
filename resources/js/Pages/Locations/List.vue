            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-sky-200 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-3 ">
                            <Link :href="route('location.create')" class="flex items-center bg-sky-500 hover:bg-blue-700 text-white font-semibold px-3 py-2 rounded mx-2" as="button">
                        ...
                        <div class="p-6 text-sky-900">
                            <div class="overflow-x-auto w-full">
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr class="text-xs font-semibold TableRowacking-wide text-left text-black-900 uppercase bg-sky-200 border-b">
