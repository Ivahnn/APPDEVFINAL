          ...
          <div class="flex md:items-center m-6">
            <form class="w-full max-w-sm" @submit.prevent="submit">
              ...
              >
                ...
                <option v-for="route in routes" :key="route.id" :value="route.id">{{ route.origin }} - {{ route.destination }}</option>
              </select>
              ...
              >
                ...
                <option v-for="bus in buses" :key="bus.id" :value="bus.id">{{ bus.code }} - {{ bus.type }}</option>
              </select>
